...
if [ $# -eq 0 ]
  then
    echo "Script to split audio or video files into chunks based on .srt timecodes"
    echo ""
    echo "usage: split-av-file-by-srt [audio-video file] [subtitle file] (optional)[output format]"
